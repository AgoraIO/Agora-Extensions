...
public class EffectAndFilterSelectAdapter extends RecyclerView.Adapter<EffectAndFilterSelectAdapter.ItemViewHolder> {
    ...
    public static final String[] EFFECT_ITEM_FILE_NAME = {
            "none",
            "anim_model.bundle",
            "ardata_ex.bundle",
    ...
    public final static int[] BEAUTY_FILTERS_NAME_SHOW = {R.string.ziran, R.string.danya, R.string.fennen, R.string.qingxin, R.string.hongrun};
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        switch (mOwnerRecyclerViewType) {
            ...
            case RECYCLEVIEW_TYPE_BEAUTY_FILTER:
                ...
                holder.mItemView.setItemText(BEAUTY_FILTERS_NAME_SHOW[adapterPosition % BEAUTY_FILTER_ITEM_RES_ARRAY.length]);

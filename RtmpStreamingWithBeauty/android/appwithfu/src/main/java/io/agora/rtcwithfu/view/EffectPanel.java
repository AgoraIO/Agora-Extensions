...
public class EffectPanel {
    ...
    public EffectPanel(RecyclerView typeList, LinearLayout effectLayout, @NonNull FURenderer renderer,
                       EffectRecyclerAdapter.OnDescriptionChangeListener listener) {
        initPermissions();

        mContext = typeList.getContext();
    ...
    private void addBeautyPanel() {
        ...
        control.setOnDescriptionShowListener(new BeautyControlView.OnDescriptionShowListener() {
            ...
            public void onDescriptionShowListener(int str) {
                Toast.makeText(mContext, mContext.getString(str), Toast.LENGTH_SHORT).show();
            }
        });
        control.onResume();
    }
    ...
    private int toEffectType(int functionName) {
        if (functionName == R.string.home_function_name_normal) {
            return Effect.EFFECT_TYPE_NORMAL;
        } else if (functionName == R.string.home_function_name_ar) {
            return Effect.EFFECT_TYPE_AR;
        } else if (functionName == R.string.home_function_name_expression) {
            return Effect.EFFECT_TYPE_EXPRESSION;
        } else if (functionName == R.string.home_function_name_background) {
            return Effect.EFFECT_TYPE_BACKGROUND;
        } else if (functionName == R.string.home_function_name_gesture) {
            return Effect.EFFECT_TYPE_GESTURE;
        } else if (functionName == R.string.home_function_name_animoji) {
            return Effect.EFFECT_TYPE_ANIMOJI;
        } else if (functionName == R.string.home_function_name_portrait_drive) {
            return Effect.EFFECT_TYPE_PORTRAIT_DRIVE;
        } else if (functionName == R.string.home_function_name_face_warp) {
            return Effect.EFFECT_TYPE_FACE_WARP;
        } else if (functionName == R.string.home_function_name_music_filter) {

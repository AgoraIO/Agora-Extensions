...
import io.agora.demo.streaming.videofilter.VideoFilterWrapper;
...
public class LiveActivity extends BaseActivity {
    ...
    private VideoFilterWrapper mVideoFilterWrapper;
    ...
    private void initUIAndData() {
        ...
        // beauty views
        mBeautyLayout = mVideoFilterWrapper.getBeautyContainer();
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        params.addRule(RelativeLayout.ABOVE, bottomContainer.getId());
        mViewRoot.addView(mBeautyLayout, params);
    ...
    private void initLiveStreaming() {
        ...
        // video filter
        if (mVideoFilterWrapper != null) {
            mVideoFilterWrapper.init(this, mLocalView);
        }
    ...
    public void onSwitchCameraClicked(View view) {
        ...
        if (mVideoFilterWrapper != null) {
            ...
            mVideoFilterWrapper.onCameraChange(currentCameraType, inputImageOrientation);
        }
    ...
    public void onBeautyClicked(View view) {
        ...
        if (view.isActivated()) {
            ...
            if (mVideoFilterWrapper != null) {
                mPresenter.addVideoFilter(mVideoFilterWrapper);
                showToast(getString(R.string.fu_face_tracking_time_tips));
            }
        } else {
            mBeautyLayout.setVisibility(View.GONE);
            if (mVideoFilterWrapper != null) {
                mPresenter.removeVideoFilter(mVideoFilterWrapper);
            }
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        if (mVideoFilterWrapper != null) {
            mVideoFilterWrapper.onActivityResume();
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        if (mVideoFilterWrapper != null) {
            mVideoFilterWrapper.onActivityPause();
        }
    }
